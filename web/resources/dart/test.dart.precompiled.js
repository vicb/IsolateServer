...
["", "test.dart", , V, {
  ...
  initWebSocket: function(retrySeconds) {
    ...
    P.print("Message: " + "Connecting to websocket");
    t2 = W.WebSocket_WebSocket("ws://10.12.181.76:8888/ws/", null);
    $.ws = t2;
    t1 = new V.initWebSocket_scheduleReconnect(t1, retrySeconds);
    t2 = H.setRuntimeTypeInfo(new W._EventStream(t2, C.EventStreamProvider_open._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new V.initWebSocket_closure()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t2 = $.ws;
    t2.toString;
    t2 = H.setRuntimeTypeInfo(new W._EventStream(t2, C.EventStreamProvider_close._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new V.initWebSocket_closure0(retrySeconds, t1)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t2 = $.ws;
    t2.toString;
    t2 = H.setRuntimeTypeInfo(new W._EventStream(t2, C.EventStreamProvider_error._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new V.initWebSocket_closure1(t1)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t2 = $.ws;
    t2.toString;
    t2 = H.setRuntimeTypeInfo(new W._EventStream(t2, C.EventStreamProvider_message._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new V.initWebSocket_closure2()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
  },
  main: [function() {
    V.initWebSocket(2);
    P.print("Hello World !");
  ...
  initWebSocket_scheduleReconnect: {
    ...
    call$0: function() {
      ...
      if (!t1.reconnectScheduled_0) {
        ...
        P.Timer_Timer(P.Duration$(0, 0, 0, 1000 * t2, 0, 0), new V.initWebSocket_scheduleReconnect_closure(t2));
      }
  ...
  initWebSocket_scheduleReconnect_closure: {
    ...
    call$0: function() {
      return V.initWebSocket(this.retrySeconds_2 * 2);
    }
  },
  initWebSocket_closure: {
    "": "Closure:10;",
    call$1: function(e) {
      P.print("Message: " + "Connected");
  ...
  initWebSocket_closure0: {
    ...
    call$1: function(e) {
      P.print("Message: " + ("Websocket closed, retrying in " + this.retrySeconds_3 + " seconds"));
  ...
  initWebSocket_closure1: {
    ...
    call$1: function(e) {
      P.print("Message: " + "Error connecting to ws");
  ...
  initWebSocket_closure2: {
    "": "Closure:20;",
    call$1: function(e) {
      P.print("Message: " + ("Received message: " + H.S(J.get$data$x(e))));
    }
  }
},
1],
